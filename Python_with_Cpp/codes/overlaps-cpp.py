...
def get_input():
    ...
    # Read in 3 command line parameters here:
    #           box size (Ang), number_of_atoms, and the Random Seed.
    if len(sys.argv) < 3:
...
overlaps = mycpplib.check_overlaps(conf)
# overlaps = mycpplib.check_overlaps_mem(conf)
